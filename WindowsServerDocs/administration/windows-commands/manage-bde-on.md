...
|-RemoveVolumeShadowCopies|Force deletion of Volume Shadow Copies for the volume. You will not be able to restore this volume using previous system restore points after running this command. You can also use **-rvsc** as an abbreviated version of this command.|
